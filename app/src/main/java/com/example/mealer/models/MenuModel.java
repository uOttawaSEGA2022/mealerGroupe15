...
import com.example.mealer.recyclerviewclasses.CommandeRecyclerViewAdapter;
...
public class MenuModel {
    ...
    public ArrayList<RepasModel> menuArray;
    public ArrayList<RepasModel> menuDuJourArray;
    public ArrayList<RepasModel> allMenuDuJourArray;
    public ArrayList<commandeModel> commandeArray;
    public ArrayList<commandeModel> demandesArray;

    private static final MenuModel menu = new MenuModel();

    String cuisinierId = Cuisinier.getInstance().getId();
    String clientId = Client.getInstance().getId();
    ...
    public void save(String idCuisinier, RepasModel ancien, RepasModel nouveau, AppCompatActivity activity){
        ...
        menuArray.remove(ancien);

        // Adding to the array
        menuArray.add(nouveau);

        // Adding to the database
        myRef = database.getReference("Cuisinier/" + idCuisinier + "/menu");

        // Adding the repas to the database
        myRef.child(ancien.getRepasId()).setValue(nouveau);
    }
